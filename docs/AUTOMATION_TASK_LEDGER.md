...
- Post-closure W7 hardening reuses the Session refresh contract for authorization-denial paths, including Agent commit `077ddeb9ae405f8b9ba55602c94a6a364d5caf41`
...
| P6-W7-15 | permission revoked during active session | Permission / Session | P0 | DONE | Marketing-A | P5 permission baseline | - | `docs/P6-W7O-ACTIVE-SESSION-REVOKE-BASELINE.md` | CI `33939458495` PASS on latest W7 head | `006c2ea5a69d9852732456f46739c01468218d6e` | 2026-09-05T10:36+08:00 |
